      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-lg text-center shadow-sm">
            ...
            <a href="#" className="text-[#050A30] font-semibold hover:text-[#050A30]/80 transition-colors">
              Explore Resources <i className="fas fa-arrow-right ml-1"></i>
            </a>
          </div>
        ...
        {/* Featured Resource */}
        <div className="mt-16 bg-[#050A30] rounded-lg p-8 text-white text-center">
          ...
          <Button className="bg-white text-[#050A30] px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors inline-flex items-center">
            Take Assessment Now
