...
import { FaCompass, FaCheck, FaCalendarCheck, FaArrowRight, FaRocket } from 'react-icons/fa';
import { updatePageSEO, SEO_DATA } from "@/lib/seo";
import { useEffect } from "react";

export default function NavigateBusinessGrowthPage() {
  useScrollToTop();
  const [, setLocation] = useLocation();

  // Update SEO
  useEffect(() => {
    const seoData = SEO_DATA.navigateBusinessGrowth;
  ...
  const benefits = [
    {
      ...
      description: "Develop comprehensive roadmaps that align with your vision and market opportunities."
    },
    {
      title: "Practice Optimization", 
      description: "Maximize efficiency and profitability through proven operational improvements."
    },
    {
      title: "Brand Development",
      description: "Build a compelling personal and professional brand that attracts ideal clients."
    },
    {
      title: "M&A Readiness",
      description: "Position your practice for successful acquisitions or strategic partnerships."
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                Scale Your Healthcare Practice with Confidence
              </h1>
              
              <p className="text-xl text-gray-600 leading-relaxed">
                Transform your healthcare practice from a job into a thriving business enterprise. Our Navigate Business Growth services help you build scalable systems, optimize operations, and create sustainable growth that doesn't depend on your constant presence.
              </p>
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <img 
                  ...
                  alt="Healthcare professionals collaborating on business growth strategy"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Our Navigate Business Growth Services
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive solutions to help you build, scale, and optimize your healthcare practice for sustainable growth.
            </p>
          </motion.div>
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 px-2">
            Let's Navigate Your Path to Sustainable Growth
          </h2>
          
          <p className="text-base sm:text-lg md:text-xl mb-6 sm:mb-8 text-white/90 max-w-3xl mx-auto px-2">
            Schedule your complimentary strategy session to discover how our Navigate Business Growth services can transform your healthcare practice into a thriving enterprise.
          </p>
          ...
          >
            <span className="hidden sm:inline">Schedule Your Strategy Session</span>
            <span className="sm:hidden">Schedule Strategy Session</span>
            <FaCalendarCheck className="ml-2 group-hover:translate-x-1 transition-transform" />
          </Button>
          
          <p className="text-sm text-white/70 mt-6">
            ✓ Complimentary consultation • ✓ No obligation • ✓ Proven growth strategies
          </p>
        </div>
      </motion.section>
